...
int main() {
	...
	int maximum_i = arr_indexes1[0];
	int maximum_j = arr_indexes2[0];
	int minimum = arr_meanings[0];
	int minimum_i = arr_indexes1[0];
	int minimum_j = arr_indexes2[0];

	for (int i = 0; i < len; i++) {

		if (arr_meanings[i] > maximum && arr_meanings[i] > 0) {
